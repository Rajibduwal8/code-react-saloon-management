        ...
        <div className="relative z-10 w-full max-w-md p-8 sm:p-10 flex flex-col h-full justify-center">
          ...
          <form onSubmit={validation.handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex items-center justify-between mt-2">
              ...
              <Link href="/forgot-password" className="text-white hover:text-gray-200 text-sm transition-colors">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="text-center text-white mt-4">
              ...
              <Link href="/register" className="text-[#e2a84a] hover:text-[#f3b552] font-medium transition-colors">
                Register
              </Link>
            </div>
          </form>
