...
const PUBLIC_PATHS = [
  ...
  "/auth/login", // Added login to public paths
  "/refresh",
];
...
_BaseAPIService.instance = axios.create({
  // Use config from window if available, otherwise default to a known value
  baseURL: typeof window !== 'undefined' && window.APP_CONFIG ? window.APP_CONFIG.api1.baseapi : "https://api-uat-cloud.restroorder.com/api",
});
