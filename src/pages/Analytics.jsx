...
const TOP_SERVICES = [
  {
    name: "Detoxifying Clay Mask Facial",
    bookings: 142,
    revenue: "NPR 213,000",
    growth: "+12%",
    trend: "up",
  ...
  {
    name: "Aromatherapy Full Body Spa",
    bookings: 98,
    revenue: "NPR 147,000",
    growth: "+8%",
    trend: "up",
  ...
  {
    name: "Lamination Brow Architecture",
    bookings: 76,
    revenue: "NPR 114,000",
    growth: "+21%",
    trend: "up",
...
const KPIS = [
  ...
  },
  {
    label: "New Clients",
    value: "84",
    sub: "↑ 22% vs last period",
    accent: "#4CAF50",
  },
  {
    label: "Course Enrollments",
    value: "37",
    sub: "↑ 9.1% vs last period",
    accent: "#4CAF50",
  },
];
        ...
        >
          <div>
            ...
            <div className="page-subtitle">
              Business intelligence, performance metrics, and revenue insights.
            </div>
          </div>
            ...
            >
              ...
              <div
                style={{
                  ...
                  fontSize: k.value.length > 8 ? 16 : 22,
                  fontWeight: 700,
                  color: "var(--dark)",
                  marginBottom: 6,
                  lineHeight: 1.2,
              ...
              <div style={{ fontSize: 10, color: k.accent, fontWeight: 600 }}>
                {k.sub}
              </div>
            </div>
          ))}
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 11,
                      fontWeight: 700,
                      color: s.trend === "up" ? "#4CAF50" : "#E05C5C",
                      flexShrink: 0,
                    }}
                  >
                    {s.growth}
          ...
          >
            <div>
              ...
              <div
                style={{ fontSize: 11, color: "var(--muted)", marginTop: 2 }}
              >
                Sessions, revenue, and ratings by therapist
              </div>
            </div>
          </div>
